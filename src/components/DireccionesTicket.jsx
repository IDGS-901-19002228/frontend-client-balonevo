...
const DireccionesTicket = () => {
    ...
    const handleRegistrarDireccion = () => {
    ...
    const seleccionarDireccion = (direccion) => { 
        ...
        if (authState.isAuthenticated) {
        // Lógica para realizar el pedido (usuario autenticado)
        navigate(`/tarjetas-ticket/${usuario?.usuario}`, {state: {direccionData: direccion}});
    ...
    return (
        <div className='m-4 container mx-auto px-8 bg-white border border-gray-200 rounded-lg'>
            ...
            <button onClick={handleRegistrarDireccion} className="mt-4 bg-green-500 text-white p-2 rounded-md hover:bg-green-600">
...
export default DireccionesTicket