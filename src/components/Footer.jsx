...
const Footer = () => {
    ...
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                    <img src="/public/logo_transparente.png" style={{ maxWidth: '40%', width: '100%', height: '40%' }} className="mr-3 h-8" alt="FlowBite Logo" />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        ...
                        <NavLink to="/about">
                            <li>
                                <a href="https://tailwindcss.com/" className="hover:underline">Acerca de</a>
                            </li>
                        </NavLink>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://twitter.com/" className="hover:underline ">Twitter - X</a>
                        </li>
                        <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">BalonEvo™</a>. All Rights Reserved.
            </span>
