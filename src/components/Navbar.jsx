...
const Navbar = () => {
    ...
    const [showProfileMenuResponsive, setShowProfileMenuResponsive] = useState(false);
    ...
    const handleToggleProfileMenuResponsive = () => {
        setShowProfileMenuResponsive(!showProfileMenuResponsive);
    }

    const navigate = useNavigate();

    function handleSearch(searchTerm) {
        navigate('/resultados?q=' + searchTerm); 
      }
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <div className='flex ml-5 space-x-2'>
                            <NavLink to="/carrito">
                                    <button type="button" id="carrito" className="relative carrito focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <svg
                        ...
                        <button onClick={handleToggleProfileMenuResponsive} className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" >
